...
=======
tsize.files <- list.files(file.path(paths$git, 'data','tumor-size'), pattern = "AOT", full.names = T, recursive = TRUE)
# tsize.files <- c(tsize.files[3:10], tsize.files[1])


tsize.raw <- lapply(tsize.files, readxl::read_xlsx)

inject.dates <- read_excel(file.path(paths$onedrive, "data", "mimic_injection_dates.xlsx"))
>>>>>>> Stashed changes
