...
tsize.raw <- lapply(1:12, function(x) read_excel(file.path(tsize.files[x], tsize.file.2[x])))
...
```{r}
write.csv(mimic.cleaned, "../data/2022-07-25_tumor-size_R-formatted.csv", row.names = F)
```