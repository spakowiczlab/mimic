...
```{r}
tsizes <- read.csv("../data/2022-03-03_tumor-size_R-formatted.csv", stringsAsFactors = F)
```
...
write.csv(mean.vals, "../shiny-apps/tumor-line-plots/2022-03-03_mean-tumor-volumes.csv", row.names = F)
```
