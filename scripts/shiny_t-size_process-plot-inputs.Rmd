...
```{r}
tsizes <- read.csv("../data/2022-02-15_tumor-size_R-formatted.csv", stringsAsFactors = F)
```
...
write.csv(mean.vals, "../shiny-apps/tumor-line-plots/2022-02-15_mean-tumor-volumes.csv", row.names = F)
```
