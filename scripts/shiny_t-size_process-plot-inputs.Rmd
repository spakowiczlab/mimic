...
```{r}
tsizes <- read.csv("../data/2022-05-09_tumor-size_R-formatted.csv", stringsAsFactors = F)
```
...
write.csv(mean.vals, "../shiny-apps/tumor-line-plots/2022-05-09_mean-tumor-volumes.csv", row.names = F)
```
