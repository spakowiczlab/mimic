...
```{r}
tsizes <- read.csv("../data/2022-01-24_tumor-size_R-formatted.csv", stringsAsFactors = F)
```
...
write.csv(mean.vals, "../shiny-apps/tumor-line-plots/2022-01-24_mean-tumor-volumes.csv", row.names = F)
```
