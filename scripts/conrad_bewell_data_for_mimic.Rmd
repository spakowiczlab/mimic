...
ggplot(aes(x = estimate, y = -log(p.value), label = pointlabs, fontface = "italic", color = TaxaLevel)) +
  # xlim(-50, 50) +
  ylim(0, 5) +
  geom_point() +
  theme_bw() +
  ...
  # scale_fill_discrete(name = "Taxa Level", breaks = c("c", "f", "g", "k", "o", "p", "s"), labels = c("Class", "Family", "Genus", "Kingdom", "Order", "Phylum", "Species"))
